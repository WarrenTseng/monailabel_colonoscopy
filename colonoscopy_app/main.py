...
class MyApp(MONAILabelApp):
    def __init__(self, app_dir, studies, conf):
        ...
        spatial_size = json.loads(conf.get("spatial_size", "[3, 352, 352]"))
        ...
        super().__init__(
            ...
            studies=studies,
            conf=conf,
            name="MONAILabel - Colonoscopy",
            description="DeepLearning models for colonoscopy",
        )
...
def main():
    ...
    app.train(
        request={
            "name": "colonoscopy_model_deepedit",
            "model": model,
            "max_epochs": 5,
